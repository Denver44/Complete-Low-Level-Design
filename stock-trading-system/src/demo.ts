...
// TODO: Create 2 stock exchanges (BSE, NSE)
const bse = new StockExchange('BSE');
const nse = new StockExchange('NSE');

// TODO: Create subscribers (2 bots, 1 portfolio tracker)
...
// TODO: Publish AMZN updates with increasing versions
...
// TODO: Publish GOOG with v2 FIRST, then v1 (v1 should be rejected)
...
// TODO: Publish TSLA from both BSE and NSE with different versions
